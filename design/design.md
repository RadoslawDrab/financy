...
<div style="display: flex; flex-wrap: wrap; gap: 2em;">
  ...
  <div style="display: grid; grid-template-columns: repeat(2, auto); gap: 1em; width: max-content; max-width: 100%">
    ...
    <span style="color: #aaa">100</span>
    <span style="color: #f1f3f5">#f1f3f5</span>
    <span style="color: #aaa">200</span>
  ...
  <div style="display: grid; grid-template-columns: repeat(2, auto); gap: 1em; width: max-content; max-width: 100%">
    ...
    <span style="color: #aaa">700</span>
    <span style="color: #f59f00">#f59f00</span>
    <span style="color: #aaa">800</span>
...
<div style="display: grid; grid-template-columns: auto auto auto; gap: 1em; width: max-content; max-width: 100%">
  ...
  <span style="color: #aaa">1.25</span>
  <div>
    <p style="line-height: 1.25">Lorem ipsum odor amet, consectetuer adipiscing elit. Sapien molestie nullam nulla finibus lacus. Ornare vestibulum tincidunt dapibus condimentum nibh. Lobortis nam posuere euismod cubilia maximus dis. Ante aliquam ad iaculis morbi vestibulum dolor arcu eros integer.</p>
    <p style="line-height: 1.25; font-size: 1.563rem">Lorem ipsum odor amet, consectetuer adipiscing elit. Sapien molestie nullam nulla finibus lacus. Ornare vestibulum tincidunt dapibus condimentum nibh.</p>
    <p style="line-height: 1.25; font-size: 3.815rem">Lorem ipsum odor amet, consectetuer adipiscing elit.</p>
  </div>
  <span style="color: #aaa">md</span>
  <span style="color: #aaa">1.5</span>
  <div>
    <p style="line-height: 1.5">Lorem ipsum odor amet, consectetuer adipiscing elit. Sapien molestie nullam nulla finibus lacus. Ornare vestibulum tincidunt dapibus condimentum nibh. Lobortis nam posuere euismod cubilia maximus dis. Ante aliquam ad iaculis morbi vestibulum dolor arcu eros integer.</p>
    <p style="line-height: 1.5; font-size: 1.563rem">Lorem ipsum odor amet, consectetuer adipiscing elit. Sapien molestie nullam nulla finibus lacus. Ornare vestibulum tincidunt dapibus condimentum nibh.</p>
    <p style="line-height: 1.5; font-size: 3.815rem">Lorem ipsum odor amet, consectetuer adipiscing elit.</p>
  </div>
  <span style="color: #aaa">lg</span>
  <span style="color: #aaa">1.65</span>
  <div>
    <p style="line-height: 1.65">Lorem ipsum odor amet, consectetuer adipiscing elit. Sapien molestie nullam nulla finibus lacus. Ornare vestibulum tincidunt dapibus condimentum nibh. Lobortis nam posuere euismod cubilia maximus dis. Ante aliquam ad iaculis morbi vestibulum dolor arcu eros integer.</p>
    <p style="line-height: 1.65; font-size: 1.563rem">Lorem ipsum odor amet, consectetuer adipiscing elit. Sapien molestie nullam nulla finibus lacus. Ornare vestibulum tincidunt dapibus condimentum nibh.</p>
    <p style="line-height: 1.65; font-size: 3.815rem">Lorem ipsum odor amet, consectetuer adipiscing elit. </p>
  </div>
  <span style="color: #aaa">xl</span>
  <span style="color: #aaa">1.8</span>
  <div>
    <p style="line-height: 1.8">Lorem ipsum odor amet, consectetuer adipiscing elit. Sapien molestie nullam nulla finibus lacus. Ornare vestibulum tincidunt dapibus condimentum nibh. Lobortis nam posuere euismod cubilia maximus dis. Ante aliquam ad iaculis morbi vestibulum dolor arcu eros integer.</p>
    <p style="line-height: 1.8; font-size: 1.563rem">Lorem ipsum odor amet, consectetuer adipiscing elit. Sapien molestie nullam nulla finibus lacus. Ornare vestibulum tincidunt dapibus condimentum nibh.</p>
    <p style="line-height: 1.8; font-size: 3.815rem">Lorem ipsum odor amet, consectetuer adipiscing elit.</p>
  </div>
</div>
